          ...
          <div className="border-top-light pt-30">
            <div className="row x-gap-20 y-gap-20">
              <div className="col-md-auto">
                <div className="w-200 md:w-1/1 rounded-4">
              ...
              <div className="col-md">
                ...
                <h3 className="text-16 lh-17 fw-500 mt-5">
                  {item?.title}
              ...
              <div className="col-md-auto text-right md:text-left">
                ...
                <Link
                  to={`/cruise-single/${item.id}`}
                  className="button px-24 py-10 -dark-1 bg-blue-1 text-white mt-15"
                >
